    ...
    <section className="section-space pt-0">
      <div className="site-shell">
        <div className="card relative overflow-hidden px-6 py-10 sm:px-10 sm:py-12">
          <div className="pointer-events-none absolute -right-24 -top-24 h-56 w-56 rounded-full bg-(--color-accent)/25 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-16 -left-16 h-52 w-52 rounded-full bg-(--color-cream)/50 blur-2xl" />
